...
export default function Login() {
  ...
  return<>
  <form className="max-w-md mx-auto py-5" onSubmit={formik.handleSubmit}>
...
<Link to='/forgetpassword' className='flex '>
      <button className=" text-white bg-blue-700 mt-7 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Forget password ?</button>
</Link>
</form>
  </>
