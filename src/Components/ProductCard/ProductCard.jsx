...
export default function ProductCard(props) {
  ...
  const { addToWishlist, handleClick, wishlistItems } =
      ...
      <div className="card rounded-3xl p-5 hover:shadow-lg hover:shadow-[#479747] transition-shadow duration-300 ">
        ...
        <div className="flex">
          <button
            ...
            className="w-3/4 h-10 m-auto bg-[#479747] text-white rounded-xl mt-5 block "
          >
            ADD
          </button>
          <button
            ...
            className=" text-black rounded-xl mt-5 block "
          >
            <i
              className={`${
