...
export default function Footer() {
  return (
    <div className="bg-[#F8F9FA] pt-8 pb-12 mt-5">
        ...
        <div className="">
          ...
          <div className="flex justify-between flex-col md:flex-row mb-5">
            <input
              type="email"
              id="email"
              className="border border-gray-300 text-sm rounded-lg w-[100%] md:w-[75%] p-2.5 placeholder-gray-500 focus:border-lime-500 mr-2"
              placeholder="Email .."
              required
            />
            <button className="px-6 py-2 w-[50%] mt-3 md:mt-0 md:w-[25%] lg:w-[20%] bg-[#479747] text-white rounded-md">
              Share App Link
            </button>
          </div>
        </div>
