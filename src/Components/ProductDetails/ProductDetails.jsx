  ...
  <div className="grid grid-cols-6 w-[80%] m-auto">
    ...
    <div className="ps-5 col-span-6 sm:col-span-4 flex flex-col justify-center">
            ...
            <div className='flex justify-between'>
              ...
              <span><i className="fa-solid fa-star text-yellow-400"></i> {details?.ratingsAverage}</span>
            </div>
            <div>
              <button onClick={()=>addToCart(id)} className='w-1/2 h-10 m-auto bg-[#479747] text-white rounded-xl mt-5 block '>ADD</button>
            </div>
    </div>
  </div>
  </>
